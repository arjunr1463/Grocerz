  ...
  return (
    <div className="flex flex-col gap-[25px]">
      <div className="flex gap-[10px] items-center text-[#2ad5b1] bg-white shadow-lg px-[15px] py-[10px] text-[15px] font-poppins">
        ...
        <span className="text-[#3d8879]">Users</span>
        <i>
          <AiOutlineRight />
        </i>
        <span className="text-[#3d8879]">Primary Users</span>
      </div>
      <div className="mx-[10px] sm:mx-[20px] flex flex-col gap-[10px]">
        <h className="font-mont font-semibold text-[22px]">Primary Users</h>
              ...
              <thead>
                <tr>
                  ...
                  <th className="border-[1px]" onClick={() => handleSort("id")}>
                    <div className="flex items-center cursor-pointer w-[100px] xl:w-auto">
                  ...
                  <th className="border-[1px]" onClick={() => handleSort("id")}>
                    <div className="flex items-center cursor-pointer w-[120px] xl:w-auto">
                      <span>Full Name</span>
                      <i className="text-[12px] text-gray-400">
                        <BiSort />
                      </i>
                  ...
                  <th className="border-[1px] ">
                    <div className="w-[140px] xl:w-auto">View Credit Order</div>
                  </th>
                </tr>
              </thead>
              <tbody>
                {paginatedData.map((data, index) => (
                  <tr key={index}>
                    ...
                    <td className="border-[1px]">{data.location}</td>
                    <td className="border-[1px]">{data.status}</td>
                    <td className="border-[1px]">{data.status}</td>
                    <td className="border-[1px]">{data.status}</td>
                    <td className="border-[1px] text-[#189279]">View</td>
                    <td className="border-[1px] text-[#189279]">View Order</td>
                    <td className="border-[1px] text-[#189279]">View Credit Order</td>
                  </tr>
                ))}
              </tbody>
              <thead>
                <tr>
                  ...
                  <th className="border-[1px] ">View Credit Order</th>
                </tr>
              </thead>
            </table>
          </div>
