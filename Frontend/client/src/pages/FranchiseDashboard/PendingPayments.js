  ...
  return (
    <div className="flex flex-col gap-[25px]">
      <div className="flex gap-[10px] items-center text-[#2ad5b1] bg-white shadow-lg px-[15px] py-[10px] text-[15px] font-poppins">
        ...
        <span className="text-[#3d8879]">Payments</span>
        <i>
          <AiOutlineRight />
        </i>
        <span className="text-[#3d8879]">Pending payments</span>
      </div>
      <div className="mx-[10px] sm:mx-[20px] flex flex-col gap-[10px]">
        <h className="font-mont font-semibold text-[22px]">Pending payments</h>
