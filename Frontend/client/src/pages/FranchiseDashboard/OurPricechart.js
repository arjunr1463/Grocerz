...
function OurPricechart() {
  const [tableData, setTableData] = useState([
    {
      id: 1,
      title: "Pavizham Rice Flakes",
  ...
  return (
    <div className="flex flex-col gap-[25px]">
      <div className="flex gap-[10px] items-center text-[#2ad5b1] bg-white shadow-lg px-[15px] py-[10px] text-[15px] font-poppins">
        ...
        <span className="text-[#3d8879]">Our Price</span>
      </div>
      <div className="mx-[10px] sm:mx-[20px] flex flex-col gap-[10px]">
        <h className="font-mont font-semibold text-[22px]">Our Price Chart</h>
            ...
            <table className="border-[1px] text-center font-poppins text-[15px] text-gray-500">
              <thead>
                <tr>
                  ...
                  <th className="border-[1px]"><div className="w-[150px] xl:w-auto">Product Availability</div></th>
                  <th className="border-[1px]">Edit</th>
                </tr>
              </thead>
              <tbody>
                {paginatedData.map((data, index) => (
                  <tr key={index}>
                    ...
                    <td className="border-[1px]">{data.title}</td>
                    <td className="border-[1px]">{data.category}</td>
                    <td className="border-[1px]">{data.subcategory}</td>
                    <td className="border-[1px]">{data.pricingunit}</td>
                    <td className="border-[1px]">{data.Status}</td>
                    <td className="border-[1px] text-[#189279]">View</td>
                    <td className="border-[1px]">
                      <button className="bg-[#189279] text-white px-[10px] py-[3px]">
                        {data.productavailability}
                      </button>
                    </td>
                    <td className="border-[1px] text-[#189279]">Edit</td>
                  </tr>
                ))}
              </tbody>
              <thead>
                <tr>
                  ...
                  <th className="border-[1px]">Product Title</th>
                  <th className="border-[1px]">Category</th>
                  <th className="border-[1px]">Subcategory</th>
                  <th className="border-[1px]">Pricing Unit</th>
                  <th className="border-[1px]">Status</th>
                  <th className="border-[1px]">View</th>
                  <th className="border-[1px]">Product Availability</th>
                  <th className="border-[1px]">Edit</th>
                </tr>
              </thead>
            </table>
