...
import { SidebarContext } from "../../context/FranchiseSidebar";
import Menu from "../../components/FranchiseDashboard/Menu";
    ...
    <div className="bg-[#202020] ">
      <div className="hidden lg:flex items-center justify-between px-[10px] py-4 mx-auto ">
        <div className="flex items-center gap-[40px]">
          ...
          <button onClick={handleClick} className="text-white text-[25px]">
            {action ? <HiArrowLeft /> : <HiMenu />}
          </button>
          <img
            src={Logo}
            alt="logo"
