  ...
  return (
    <div className="flex flex-col gap-[25px]">
      <div className="flex gap-[10px] items-center text-[#2ad5b1] bg-white shadow-lg px-[15px] py-[10px] text-[13px] mob:text-[15px] font-poppins">
        ...
        <span className="text-[#3d8879]">All Products</span>
      </div>
      <div className="mx-[10px] sm:mx-[20px] flex flex-col gap-[10px]">
        <h className="font-mont font-semibold text-[22px]">All products</h>
            ...
            <table className="border-[1px] text-center font-poppins text-[15px] text-gray-500">
              <thead>
                <tr>
                  ...
                  <th className="border-[1px]">Availability</th>
              ...
              <tbody>
                {paginatedData.map((data, index) => (
                  <tr key={index}>
                    ...
                    <td className="border-[1px]">{data.productstatus}</td>
              ...
              <thead>
                <tr>
                  ...
                  <th className="border-[1px]">Title</th>
                  <th className="border-[1px]">Category</th>
                  <th className="border-[1px]">Subcategory</th>
                  <th className="border-[1px]">Product Status</th>
                  <th className="border-[1px]">Availability</th>
                  <th className="border-[1px]">View</th>
                  <th className="border-[1px]">Edit</th>
                </tr>
